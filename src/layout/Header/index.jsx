    ...
    <nav>
      <div className="navbar container">
        <div className="brand">
          ...
          <Text className="white fs-lg brand-text">LapShop</Text>
        </div>

        <ul className="links">
          <li className="box box-1">
            <a href="#" onClick={handleFormClick}>
              <Text className="white fs-xs fw-400 box-text">
                Search Lapshop
              </Text>
          ...
          <li className="box box-2">
            <Link to="/login">
              <Text className="white fs-xs">Sign In</Text>
            </Link>
          </li>
          ...
          <li className="icon">
            <Link to="/cart">
              ...
              <div className="circle">
                <Text className="white fs-xs">{cartItems.length}</Text>
              </div>
            </Link>
          </li>
        </ul>
